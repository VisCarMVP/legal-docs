...
**Version 2.2.0** &nbsp;·&nbsp; Effective: July 28, 2026
...
| OpenWeather (OpenWeather Group Ltd) | Weather data lookup along requested routes | Approximate route coordinates | United Kingdom |
...
Our primary infrastructure is hosted in the **United States** (AWS, us-east-1, Virginia). Some providers are located in the **United Kingdom** (OpenWeather) and the **European Union** (Better Stack); the UK and EU each recognise the other's data-protection framework through adequacy decisions.
